...
<body onload="GetApplet();">
    <form id="form1" runat="server">
        <div><uc1:HeaderControl ID="HeaderControl1" runat="server" /></div>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" style="top: 0px;
                ...
                <tr style="height:400px; width:800px">
                    <td colspan="3" align="center">
                        <div id="appletSection" style="margin-top:200px;">

 <%-- <applet name="TreeApplet" codebase="applets" code="STApplet.class" archive="StarTree30c.jar" WIDTH="100%" HEIGHT="450" MAYSCRIPT>
